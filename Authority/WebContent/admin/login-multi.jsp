...
<body>
   <!-- START wrapper-->
   <div style="height: 100%; padding: 20px 0; background-image:url(${pageContext.request.contextPath}/images/background.jpg)" class="row row-table">
      <div class="col-lg-3 col-md-6 col-sm-8 col-xs-12 align-middle">
         <div data-toggle="play-animation" data-play="fadeInDown" data-offset="0" class="panel b0">
            <p class="text-center mb-lg">
               <br>
               <a href="#">
                  <img src="${pageContext.request.contextPath}/images/logo.jpg" alt="Image" class="block-center img-rounded">
               </a>
            </p>
   ...
   <script type="text/javascript">
       ...
       $("#login_btn").click(function () {
           ...
           $.ajax({
               type: "POST",
               url: "${pageContext.request.contextPath}/checkloginNames",
               data: data,
   ...
   <script type="text/javascript">
       ...
       $("#signupInputName").blur(function(){
    	   ...
    	   $.ajax({
    		   type:"POST",
    		   url:"${pageContext.request.contextPath}/isExitName.do",
    		   data:data,
    		   success:function(msg){
    			   /**
    			   if(msg == "success"){
   ...
   <script type="text/javascript">
       $("#admin_login_btn").click(function () {
           ...
           $.ajax({
               type: "POST",
               url: "${pageContext.request.contextPath}/login/adminlogin",
               data: data,

               success: function (msg) {
                   if (msg == "success") {
                       window.location.href = "${pageContext.request.contextPath}/login/history";
                   }
                   else if (msg == "fail") {
                       alert("用户名或密码错误！");
                   }
