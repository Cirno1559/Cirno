...
public class AdminController {
	 ...
	 * @return
	 */
	@RequestMapping(value="isExitName")
	@ResponseBody
	public OutJson isExitName(String loginName){
		
		boolean flag = adminBiz.selectByName(loginName);
		
//		return flag ? "success" : "failure";
		OutJson outmessage = new OutJson();
		
		outmessage.setSuccess(flag);
		outmessage.setMessage(flag ? "该用户名已经注册！" : "操作失败！");
		return outmessage;
	}
